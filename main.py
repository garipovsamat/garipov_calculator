...
class Expression:
    ...
    #     return self._expression.split()[-1]
    #
    # def delete_term(self, term):
    #     terms = self._expression.split()
    #     terms.remove(term)
    #     self._expression = "".join(terms)
...
class Graphic:
    __graphics = 0
    # function.png - всегда будет такое название, которое будет удалено из папки temp
...
class Window(Tk):
    def __init__(self):
        ...
        # Grid configuration for default
        ...
        # Info, because it is in all of modes
        ...
        self.standart_calc()  # Standart is default mode
    ...
    def standart_calc(self):
        ...
        self.back = ttk.Button(text="<", command=expression.fback)
...
def update_info(expression): # сюда мы даём именно _info у Expression
